...
const blocks = [
  {
    num: '01',
    heading: 'Все активы\nв одном окне',
    desc: 'Акции, облигации, ETF, валюта и любые другие инструменты — CapitalView объединяет все виды инвестиций в единой панели с актуальными ценами.',
  ...
  },
  {
    num: '02',
    heading: 'Динамика\nроста капитала',
    desc: 'Наблюдайте, как меняется стоимость портфеля день за днём. Реальная доходность с учётом комиссий, налогов и реинвестиций — без иллюзий.',
  ...
  },
  {
    num: '03',
    heading: 'Дивиденды\nи купоны',
    desc: 'Полная история начисленных выплат и прогноз будущих. Дивиденды, купоны и амортизации — по каждому активу, с точными датами.',
  ...
  },
  {
    num: '04',
    heading: 'Структура\nи баланс',
    desc: 'Видите, как распределены ваши вложения по классам активов, секторам и валютам. Находите перекосы и поддерживайте оптимальный баланс.',
  ...
  <section id="features" class="section snap-section analytics-section">
    <div class="container analytics-container">
      <div class="analytics-header">
        ...
        <h2 class="analytics-title reveal">Всё о ваших<br>инвестициях</h2>
        <p class="analytics-desc reveal">Полная картина портфеля — от акций и облигаций до криптовалюты. Одна платформа вместо десятка таблиц.</p>
      </div>
