...
export const HERO_ASSET_PATHS = [
  ...
  'M -6 25 C 48 17 46 42 49 122',
  'M -6 54 C 24 35 44 50 50 123',
  'M -14 85 C 21 52 41 56 51 122',
  // Правый верх (зеркально)
  'M 109 28 C 72 17 54 42 51 122',
  'M 100 54 C 76 35 56 50 50 123',
  'M 112 80 C 79 52 59 56 49 122'
]
