    ...
    <div class="container integ-container">
      <div class="integ-layout reveal">
        ...
        <div class="integ-text">
          ...
          <h2 class="integ-title">Синхронизация<br>с Т-Инвестиции за 2 минуты</h2>
          <p class="integ-desc">
            Автоимпорт из Т-Инвестиции: получите полный контроль над инвестициями. Все сделки, дивиденды и купоны
            синхронизируются автоматически через официальный API брокера.
          </p>
